...
int main(int argc, char *argv[])
{
	...
	screenindexamount++;
	screenindex[screenindexamount].name = const_cast<char*>("Feet");
	screenindexamount++;
	screenindex[screenindexamount].name = const_cast<char*>("Teeth");
	screenindexamount++;
	screenindex[screenindexamount].name = const_cast<char*>("Hair");
        screenindexamount++;
	...
	while((ch = getch()) != 'q')
	{
		...
		if(ch == '?')
		{
			...
			screeny++;
			mvprintw(screeny, screenx, "The E character is an player Elf.");
			screeny++;
			mvprintw(screeny, screenx, "The O character is an player Orc.");
			screeny++;
			...
			screeny++;
			mvprintw(screeny, screenx, "The d character is an enemy Dwarf.");
			screeny++;
			mvprintw(screeny, screenx, "The h character is an enemy Human.");
			screeny++;
